...
Monster monstersArray[] = {
    ...
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=1},
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=2},
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=3},
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=4},
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=5},
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=6},
    {1, "鬼子", 1, 100, 5, 5, 1, 3, 10, 1, .Coord.X=0, .Coord.Y=7},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=0},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=1},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=2},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=3},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=4},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=5},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=6},
    {2, "汉奸", 2, 200, 8, 12, 1, 8, 11, 1, .Coord.X=0, .Coord.Y=7},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=0},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=1},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=2},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=3},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=4},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=5},
    {3, "浪人", 3, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 5, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 6, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 7, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 8, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 9, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 9, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 9, 300, 10, 10, 3, 8, 20, 1, .Coord.X=0, .Coord.Y=6},
    {3, "浪人", 9, 30000, 10, 10, 3, 8, 20, 1,.Coord.X=0, .Coord.Y=6}
};
Prop propArray[] = {
...
void ShowMonsters()
{
    ...
    //怪物总数
    int monsterCount = sizeof(monstersArray) / sizeof(Monster);
    ...
    {
        if(monstersArray[i].Coord.X == X && monstersArray[i].Coord.Y == Y && monstersArray[i].state != 0)
        {
            //记录查找出的怪物下标
    ...
    for(i = 0; i < currMapMonsterCount; i++)
    {
        ...
        printf("%d.%s(%s)\t", monstersArray[monsterIndexs[i]].id, monstersArray[monsterIndexs[i]].name, levelNames[monstersArray[currIndex].level - 1]);
    }
...
void Fight(int monsterId)
{
    ...
    int i;
    for(i = 0; i < sizeof(monstersArray) / sizeof(Monster); i++)
    {
        if(monstersArray[i].id == monsterId)
        {
            monsterIndex = i;
            break;
        }
    ...
    while(1)
    {
        ...
        monstersArray[monsterIndex].hp -= playerAttack;
        if(monstersArray[monsterIndex].hp <= 0)
        {
            break;//退出pk过程
        }
        //暂时忽视玩家的防御力
        currPlayer->hp -= monstersArray[monsterIndex].att;
        if(currPlayer->hp <= 0)
        {
            break;
        }
        ...
        SetPosition(MARGIN_X + 5, INFO_END_Y - 1);
        fightCount++;
        printf("战斗第%d轮，%sHP:%d\t%sHP:%d", fightCount, currPlayer->name, currPlayer->hp, monstersArray[monsterIndex].name, monstersArray[monsterIndex].hp);
        usleep(1000 * 200);
    }
    SetPosition(MARGIN_X + 5, INFO_END_Y - 1);
    printf("                                          ");
    ...
    SetPosition(MARGIN_X + 5, INFO_END_Y - 1);
    printf("经过艰苦的战斗，《%s》被您杀死，获得%d经验，%d金币！", monstersArray[monsterIndex].name, monstersArray[monsterIndex].exp, monstersArray[monsterIndex].maxMoney);
    currPlayer->exp += monstersArray[monsterIndex].exp;
    currPlayer->gold += monstersArray[monsterIndex].maxMoney;
}
